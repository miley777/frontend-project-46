...
const currentIndent = (depth, spaceCount, type = '') => type ? ' '.repeat(depth * spaceCount - shiftToTheLeft(spaceCount)) : ' '.repeat(depth * spaceCount);
...
const getStylish = (typedKeys) => {
  return stylish(typedKeys);
};
